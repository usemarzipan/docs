...
<Tip>
The link is shown in full rather than hidden behind a copy button, so you can read it out over the phone as easily as paste it.
</Tip>
...
The page offers card payments, plus anything else enabled in your Stripe payment method configuration — **Link** appears inline in the card row where your account has it switched on.

<Note>
Apple Pay and Google Pay aren't offered on the payment page, and nor are methods that would take the customer away to another site to pay.
</Note>
...
<Note>
The mobile app passes the link to your phone's share sheet rather than emailing it, so you choose how it reaches the customer. Sending from the web app emails it for you.
</Note>
