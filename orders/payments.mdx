...
Rather than taking the card yourself, you can send the customer a link to pay the order themselves. Available on draft and held orders that settle through Stripe. See [Payment links](/orders/payment-links).
