...
<Warning>
**Start again** can't be undone, and EzyPro may already hold the orders it resends — they could be received twice. It doesn't remove files EzyPro has already collected.
</Warning>
