...
<Frame>
<img src="https://marzipan-cloud.b-cdn.net/0/docs/web-components/account-copy.png" alt="The Account tab of Branding & Web Components, showing the editable account wording grouped into sign in and register, empty states, and subscription messages" />
</Frame>
