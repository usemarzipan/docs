...
Most of the copy in the account is yours to write: the sign in, register, verification and password reset messages, the empty states on every tab, and the explanations shown while managing a subscription. Anything left blank keeps Marzipan's wording. See [Account copy](/web-components/customisation#account-copy).
