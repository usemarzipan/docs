...
#### Quick Attributes
When enabled in your [web component settings](/web-components/customisation#quick-attributes), key product attributes (e.g. Size, Colour, Material) are displayed directly on the mini view product card. You choose which attributes to show and their display order from Settings > Web Components > Product.
