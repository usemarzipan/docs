...
Most customers create their own account when they order through your website. You can also add a customer record yourself, which is useful when you are setting up a wholesale account, taking a phone order, or bringing existing contacts into Marzipan.
